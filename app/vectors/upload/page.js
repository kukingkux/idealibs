...
export default function UploadVectorPage() {
	...
	const handleDrop = (e) => {
		...
		setPreview(
			"https://cdn3.iconfinder.com/data/icons/cad-database-presentation-spreadsheet-vector-fil-2/512/28-512.png"
		);
		console.log(preview);
	};
										...
										<div className="flex flex-col gap-6 md:gap-16">
											<div className="flex flex-col md:flex-row gap-6 mt-8">
												<div className="flex flex-col md:basis-1/3 gap-2">
													...
													>
														{preview != null && (
															<img src={preview} alt="" className="w-28" />
														)}
														{preview != null || (
															<>
																<svg
													...
													<p>Supported filetype: .svg, .pdf</p>
												</div>
