                                    ...
                                    <div className="flex flex-col gap-6 md:gap-16">
                                        <div className="flex flex-col md:flex-row gap-6 mt-8">
                                            <div className="flex flex-col gap-2">
                                                <p>Preview</p>
                                                <div
                                                    className="flex flex-col flex-nowrap items-center gap-4 bg-i03 font-semibold text-lg underline rounded-lg cursor-pointer p-8 line-clamp-1"
                                                ...
                                                >
                                                    <div
                                                        id={svg}
                                                        className={`${svgPreview} items-center justify-center py-8 max-h-16 max-w-12`}
                                                    ></div>
