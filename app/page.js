...
export default function Landing() {
	...
	return (
		<main className="flex min-h-screen flex-col bg-i01">
			<div id="navbar" className="sticky top-0 container bg-i02 py-6 px-7 z-20">
				<div className="flex justify-between items-center">
					<button onClick={toggleDrawer} className="btn btn-square bg-i03 h-10">
						{isDrawerOpen ? (
							<svg
								xmlns="http://www.w3.org/2000/svg"
								viewBox="0 0 24 24"
					...
					<IconButton
						...
						className="rounded-lg bg-i03 h-10"
					>
						{isDrawerOpen ? (
							<svg
								xmlns="http://www.w3.org/2000/svg"
					...
					<div className="flex">
						<button
							type="button"
							className="hidden lg:block rounded-full border-2 border-white bg-transparent h-10 mr-3"
						>
							<span className="block font-semibold text-sm px-5">Login</span>
						</button>
						<button
							type="button"
							className="rounded-full bg-gradient-to-r from-iorange to-ipink h-10"
						>
							<span className="block font-semibold text-sm px-5">Register</span>
						</button>
					</div>
				</div>
			</div>
			<Drawer
				id="sidebar"
				open={isDrawerOpen}
				className="bg-i02 w-1/2 z-10"
				overlay={false}
			>
				<Card color="transparent" shadow={false} className="w-full px-7">
					<div className="container py-6">
						<IconButton variant="text" className="rounded-lg bg-i03 h-10">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								viewBox="0 0 24 24"
								strokeWidth={2}
			...
			<div id="content" className="container">
				...
				>
					<p className="text-center font-medium text-xl mb-2">
						Idea is Key Unlocking the Door to Infinite Creativity at Idealibs!
					</p>
				...
				>
					...
					<p className="text-left font-light text-sm mb-3">
						Idealibs is a website that makes it easy for designers in the world
						to find sources that suppport their design needs. There are many
						sources that are widely used and various eases in accessing a source
					</p>
					<div className="flex flex-row justify-between">
						...
						<div className="flex flex-col">
							...
							<p className="text-left font-light text-sm">Designer helped</p>
						</div>
					</div>
				</div>
				<div className="flex container bg-gradient-to-r from-iorange to-ipink items-center mt-12">
					<div className="p-7">
						<p className="text-center font-medium text-sm">
							“By combining innovation, learning, and community, Idealibs forms
							an immersive and dynamic environment for those who want to push
							the boundaries of their design. Welcome to Idealibs, a place where
							ideas are the key to a world of limitless creativity.”
						</p>
					</div>
				</div>
				<div className="flex container flex-col px-7 mt-12">
					...
					<p className="text-center font-light text-sm px-8 mb-6">
						Idealibs comes with a ton of benefits that differentiate it in the
						world of creative design
					</p>
					<div className="grid grid-cols-2 gap-4">
						<div className="rounded-lg bg-gradient-to-r from-iorange to-ipink p-6">
							<div className="flex flex-col">
								...
								<p className="text-left font-medium">Limitless Inspiration</p>
							</div>
						</div>
						<div className="rounded-lg border-2 border-i02 bg-i01 p-6">
							<div className="flex flex-col">
								...
								<p className="text-left font-medium">Interactive Education</p>
							</div>
						</div>
						<div className="rounded-lg border-2 border-i02 bg-i01 p-6">
							<div className="flex flex-col">
						...
						<div className="rounded-lg border-2 border-i02 bg-i01 p-6">
							<div className="flex flex-col">
								...
								<p className="text-left font-medium">Abundant Free Resources</p>
							</div>
						</div>
						<div className="rounded-lg border-2 border-i02 bg-i01 p-6">
							<div className="flex flex-col">
								...
								<p className="text-left font-medium">Current News and Trends</p>
							</div>
						</div>
						<div className="rounded-lg border-2 border-i02 bg-i01 p-6">
							<div className="flex flex-col">
								...
								<p className="text-left font-medium">Open and Easy Access</p>
							</div>
						</div>
					</div>
				</div>
				...
				>
					...
					<div className="grid grid-cols-1 divide-y-2 border-b-2 divide-i02 border-i02">
						...
						<div className="flex flex-col py-5">
							<p className="text-left font-medium mb-2">Vectors and Graphics</p>
							<p className="text-left font-light text-sm">
								Idealibs is a website that makes it easy for designers in the
								world to find sources that suppport their design needs. There
								are many sources that are widely used and various eases in
				...
				>
					...
					<div className="grid grid-cols-1 gap-4">
						<div className="rounded-lg border-2 border-i02 bg-i01 p-7">
							<div className="flex flex-col">
								<p className="text-left font-bold text-xl mb-3">Free user</p>
								<div className="grid grid-cols-1 gap-4">
						...
						<div className="rounded-lg bg-i02 p-7">
							<div className="flex flex-col">
								<p className="text-left font-bold text-xl mb-3">Premium user</p>
								...
								>
									<span className="block font-medium text-sm">Explore now</span>
								</button>
							</div>
						</div>
					</div>
				...
				>
					...
					<div className="grid grid-cols-1 gap-4">
						<Accordion
							...
							className="rounded-lg bg-i02 px-7 py-2"
						>
							<AccordionHeader
								onClick={() => handleOpen(1)}
								className="border-b-0 text-left text-md font-medium text-white hover:text-white"
							>
								What sets Idealibs apart from other design platforms?
							</AccordionHeader>
							<AccordionBody className="pt-0 text-sm font-normal text-gray-500">
