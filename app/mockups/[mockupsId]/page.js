...
export default function MockupDetails() {
	...
	useEffect(() => {
		const fetchData = async () => {
			try {
				const res = await axiosInstance.get("/files/" + params.mockupsId);
				const res2 = await axiosInstance.get("/files?limit=8&category_id=5");
							...
							{isLoading ? (
								...
								<div id="mobile-scrollable" className="">
									<div className="px-7">
										...
										<div className="flex flex-col gap-4 mb-10">
											<p className="text-i04">More Mockups</p>
