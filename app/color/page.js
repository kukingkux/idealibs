						...
						<div id="right-content" className="min-h-screen lg:w-full">
							...
							>
								<div className="md:inline-block  w-full">
									<div className="flex flex-col justify-between p-4 lg:p-8 bg-cover rounded-lg " style={{backgroundImage: `url(${bg.src})`}}>
										...
										/>
										<div>
											<p className="font-medium lg:font-semibold text-lg lg:text-2xl pt-32 lg:pt-28 mb-2">An ideal library of ideas to develop your creative mind.</p>
											<p className="font-regular text-sm pe-96  hidden lg:block">Immerse yourself in a kaleidoscope of possibilities with our extensive collection of vibrant color palettes. From bold hues to subtle tones, Idealibs offers a diverse palette playground to elevate your design journey.</p>
										</div>
							...
							<div id="mainmenu" className="px-7">
								...
								<div className="flex flex-wrap gap-4 mb-6">
									...
									<div className="bg-i02 font-bold rounded-iform py-4 lg:py-3 px-8 lg:px-6">Pastel</div>
									<div className="bg-i02 font-bold rounded-iform py-4 lg:py-3 px-8 lg:px-6 hidden lg:block">Blue</div>
									<div className="bg-i02 font-bold rounded-iform py-4 lg:py-3 px-8 lg:px-6 hidden lg:block">Brown</div>
									<div className="bg-i02 font-bold rounded-iform py-4 lg:py-3 px-8 lg:px-6 hidden lg:block">Retro</div>
									<div className="bg-i02 font-bold rounded-iform py-4 lg:py-3 px-8 lg:px-6">Neon</div>
									<div className="bg-i02 font-bold rounded-iform py-4 lg:py-3 px-8 lg:px-6 hidden lg:block">Light</div>
									<div className="bg-i02 font-bold rounded-iform py-4 lg:py-3 px-8 lg:px-6 hidden lg:block">Dark</div>
									<div className="bg-i02 font-bold rounded-iform py-4 lg:py-3 px-8 lg:px-6">Vintage</div>
									<div className="font-bold rounded-iform py-4 lg:py-3 px-8 lg:px-16 border">See more tags</div>
								</div>
							</div>
