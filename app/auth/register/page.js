        ...
        <main className="flex min-h-screen flex-col bg-i01">
            <div className="flex flex-row">
                <div className="basis-2/3 hidden md:inline-block w-full">
                    <div className="flex flex-col justify-between p-12 h-screen bg-cover" style={{backgroundImage: `url(${bg.src})`}}>
                        <img
                        className="w-32"
                        src="/images/Logo-Nav-Desktop.png"
                        alt="Img-Login"
                        />
                        <p className="z-10">Embark on your creative journey. Enter your realm of design with a few clicks.
                            Let the inspiration unfold as you log in to your colorful canvas of possibilities.</p>
                    </div>
                ...
                <div className="flex flex-col grow justify-center basis 1/3 h-screen bg-i01 z-10 px-8 pb-8">
                    ...
                    <div className="w-full mt-2">
                        ...
                        <p className="mt-2 mb-8">Get ready to explore a world full of ideas.</p>
                    </div>
                    <div className="mb-4">
                        <p className="mb-2">Username</p>
                        <div className="flex items-center ps-6 gap-4 rounded-iform w-full h-14 bg-i03">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M21.375 11.5156C17.015 10.3916 13.608 6.98456 12.484 2.62456L12 0.747559L11.516 2.62456C10.392 6.98456 6.98505 10.3916 2.62505 11.5156L0.748047 11.9996L2.62505 12.4846C6.98505 13.6086 10.392 17.0156 11.516 21.3746L12 23.2526L12.484 21.3746C13.608 17.0156 17.015 13.6086 21.375 12.4846L23.252 11.9996L21.375 11.5156Z" fill="#FEFEFE"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M18.7511 7.74697C18.7511 6.58497 20.0251 5.24797 21.2501 5.24797C20.0711 5.24797 18.7511 3.89697 18.7511 2.74997C18.7511 3.89697 17.4431 5.24797 16.2531 5.24797C17.3981 5.24797 18.7511 6.57797 18.7511 7.74697Z" fill="#FEFEFE"/>
                            </svg>
                            
                            <input type='text' name="name" placeholder="Enter your username" className="rounded-r-iform w-full h-14 bg-i03"/>
                        </div>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex items-center ps-6 gap-4 rounded-iform w-full h-14 bg-i03">
                            ...
                            <input type='text' name="name" placeholder="Enter your email" className="rounded-r-iform w-full h-14 bg-i03"/>
                        </div>
