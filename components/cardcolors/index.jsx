		...
		<div className="w-full flex flex-col gap-4 mb-6">
			...
			<div className="w-full h-48 lg:h-96">
				...
				<Link
					...
					className="rounded-lg z-10 opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out cursor-pointer absolute bg-[radial-gradient(120.40%_180.55%_at_50.76%_60.29%,rgba(255,255,255,0.00)_0%,rgba(0,0,0,1)_100%)] inset-x-0 pt-30 text-white flex items-end"
				></Link>
			</div>
