...
export default function SideNavigation() {
    ...
    >
        <div className="container sticky top-0 min-h-screen" ref={container}>
            <div className="py-10" id="idealibs" ref={ref}>
                <img
            ...
            <div className="flex flex-col justify-between mt-3"  style={{height}}>
                ...
                <div>
                    <div className="flex flex-col gap-12 bg-gradient-to-r from-iorange to-ipink rounded-xl p-5 gap-12">
                        <div
