...
export default function MasonryGrid({ src, id }) {
	...
	return (
		<div className="overflow-hidden cursor-pointer rounded-xl relative group">
			...
			<button
				onClick={changeColor}
				className="absolute z-20 transform-gpu top-0 right-0 p-4 m-4 space-y-3 text-xl opacity-0 group-hover:opacity-100 transform transition duration-300 ease-in-out bg-slate-200/20 rounded-full hover:bg-i04/100"
			>
				<svg
					width="20"
					height="20"
