...
export default function MasonryGrid({src}){
        ...
        >
            ...
            >
                    <button onClick={changeColor}
                        class={`transform-gpu p-3 m-4 space-y-3 text-xl group-hover:opacity-100 transform transition duration-300 ease-in-out bg-slate-200/20 rounded-full hover:bg-i04/100`}
                    >
