...
export default function CardFont({ cardBg = 'i03', ratio = 'square', fontSize = '4xl', svgClass, id }) {
        ...
        >
            ...
            >
                ...
                <div className="basis-1/3 flex justify-end">
                    <svg width="32" height="32" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className={svgClass}>
